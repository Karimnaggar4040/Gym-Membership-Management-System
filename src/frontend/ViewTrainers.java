...
public class ViewTrainers {
    ...
    private static ObservableList<TrainerGui> getTrainers() {
        ...
        for (PrimaryInterface trainer : Backend.getListOfTrainers()) {
            String trainerContent = trainer.lineRepresentation();
            String[] trainerDetails = trainerContent.split(",");
            TrainerGui trainerGui = new TrainerGui(trainerDetails[0], trainerDetails[1], trainerDetails[3], trainerDetails[2], trainerDetails[4]);
